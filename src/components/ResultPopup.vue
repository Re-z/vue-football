    ...
    <md-dialog-content class="custom-dialog">
      <div class="result-box">
        <div class="result-box__item">
          <md-dialog-title class="result-box__item-title md-headline"
            >Team 1</md-dialog-title
          >

          <md-card
            class="md-primary"
            md-theme="green-card"
            v-for="player in getTeam1"
            :key="player.id"
          >
            <md-card-header>
              <md-card-header-text>
        ...
        <div class="result-box__item">
          <md-dialog-title class="result-box__item-title md-headline"
            >Team 2</md-dialog-title
          >

          <md-card
            class="md-primary"
            md-theme="green-card"
            v-for="player in getTeam2"
            :key="player.id"
          >
            <md-card-header>
...
export default {
  computed: mapGetters(["getTeam1", "getTeam2", "getResultPopupStatus"]),
  methods: {
    generateTeams() {
